...
public class UserController {
    ...
    public ResponseEntity<Object> updateUser(@PathVariable(value = "userId") UUID userId,
        ...
        log.debug("[PUT] >> method 'updateUser'. userDto received {} ", userDto.toString());
        Optional<UserModel> userModelOptional = userService.findById(userId);
        if(!userModelOptional.isPresent()) {
            return ResponseEntity.status(HttpStatus.NOT_FOUND).body("User not found.");
        }
    ...
    public ResponseEntity<Object> updatePassword(@PathVariable(value = "userId") UUID userId,
        ...
        log.debug("[PUT]>> method 'updatePassword'. userDto received {} ", userDto.toString());
        Optional<UserModel> userModelOptional = userService.findById(userId);
        if(!userModelOptional.isPresent()) {
            return ResponseEntity.status(HttpStatus.NOT_FOUND).body("User not found.");
        }
    ...
    public ResponseEntity<Object> updateImage(@PathVariable(value = "userId") UUID userId,
        ...
        log.debug("[PUT]>> method 'updateImage'. userDto received {} ", userDto.toString());
        Optional<UserModel> userModelOptional = userService.findById(userId);
        if(!userModelOptional.isPresent()) {
            return ResponseEntity.status(HttpStatus.NOT_FOUND).body("User not found.");
        }
